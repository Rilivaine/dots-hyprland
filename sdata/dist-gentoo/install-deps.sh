...
metapkgs=(illogical-impulse-{audio,backlight,basic,bibata-modern-classic-bin,breezex-bin,fonts-themes,hyprland,kde,microtex-git,portal,python,quickshell-git,screencapture,toolkit,widgets})
